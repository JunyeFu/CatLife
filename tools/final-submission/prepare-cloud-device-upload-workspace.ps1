...
$readme.Add("If the ADB endpoint exists but the device is not immediately listed, run wait-and-collect-stage9-android-evidence.ps1 with the same endpoint.")
...
$manifest.Add("")
$manifest.Add("## Wait Wrapper")
$manifest.Add("")
$manifest.Add("If a vivo cloud-device endpoint is assigned but adb does not list the device immediately, run:")
$manifest.Add("")
$manifest.Add('```powershell')
$manifest.Add('powershell -ExecutionPolicy Bypass -File tools/final-submission/wait-and-collect-stage9-android-evidence.ps1 -ApkPath "06-deliverables/final-submission/CatLife_MVP_Android_v0.1.0.apk" -CloudAdbEndpoint "<vivo cloud adb ip:port>" -TimeoutSeconds 900')
$manifest.Add('```')
$manifest.Add("")
