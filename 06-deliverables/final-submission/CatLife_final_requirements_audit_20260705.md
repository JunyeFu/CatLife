...
| Credential boundary | Real APK must include local ignored vivo key, while public materials only keep redacted evidence. | PASS | private exists=True; ignored=True; redacted evidence=True; apk boundary report=True | Keep private Resources ignored; never commit plaintext AppKEY. |
| Official deliverable | Runnable APK must be fresh against current Unity runtime source. | MISSING | C:\Users\fujunye\Desktop\Agent\05-AIGC\06-deliverables\final-submission\CatLife_apk_build_freshness_20260705.md | Close Unity if open, rebuild the APK, then rerun final gates. |
...
| Runtime evidence | Runtime code contains stable startup, focus, and LLM logcat markers. | PASS | C:\Users\fujunye\Desktop\Agent\05-AIGC\06-deliverables\final-submission\CatLife_runtime_log_marker_check_20260705.md | Keep runtime log markers before collecting cloud-device logcat evidence. |
